...
// Ensure only therapists can approve
if ($userRoles != 1) {
...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $sqlUpdate = "UPDATE appointment SET status = 'Approved' WHERE apptID = ?";
        ...
        if (mysqli_stmt_affected_rows($stmtUpdate) > 0) {
            ...
            $message = "Your appointment (ID: $apptID) has been approved.";
        ...
        header("Location: appointment.php?status=approved");
    } catch (Exception $e) {
